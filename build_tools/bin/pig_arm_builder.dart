...
import 'package:pub_release/pub_release.dart' as pr hide Version;
...
void main(List<String> args) {
  ...
  if (!current) {
    final pubspec =
        pm.PubSpec.load(directory: DartProject.self.pathToProjectRoot);
    final version = pr.askForVersion(pubspec.version.semVersion);
    pubspec.version.setSemVersion(version);
    pubspec.save();
  }
